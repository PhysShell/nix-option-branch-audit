#!/usr/bin/env python3
"""S5-F3-R section 8 (fatal/error tabulation): across all 180 applicable
...
unresolved-class signals, for both the F2-R baseline and the F3-R
...
def main():
    ...
    baseline_kinds, baseline_parse_errors = tabulate(F2R_REPLAY, manifest)
