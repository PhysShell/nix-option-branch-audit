#!/usr/bin/env python3
"""S5-F1B-R replay executor. For each applicable PR, fetch real base/head
content at the frozen SHAs, run the candidate (6c2c2aa) binary against the
...
D = ROOT / "fixtures/s5-f1b-r"
CANDIDATE = "/tmp/f1br-clean-checkout/target/release/oba"
SCRATCH = Path("/tmp/f1br-scratch")
REPO = "NixOS/nixpkgs"
