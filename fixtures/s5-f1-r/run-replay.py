#!/usr/bin/env python3
"""S5-F1-R replay executor. For each applicable PR, fetch real base/head
content at the frozen SHAs, run the candidate binary against the
original committed targets.toml, save outputs. No comparison/judgment
here -- see compare-replay.py.
"""
import base64
import json
import shutil
...
D = ROOT / "fixtures/s5-f1-r"
CANDIDATE = "/tmp/f1r-clean-checkout/target/release/oba"
SCRATCH = Path("/tmp/f1r-scratch")
REPO = "NixOS/nixpkgs"
