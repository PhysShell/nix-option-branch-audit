#!/usr/bin/env python3
"""S5-F2-R replay executor. For each applicable PR, fetch real base/head
content at the frozen SHAs, run the candidate (c647d1b) binary against the
original committed targets.toml, save outputs. Adapted verbatim from
fixtures/s5-f1d-r/run-replay.py -- only the candidate binary path and
...
CANDIDATE = "/home/tandem/f2r-clean-checkout/target/release/oba"
SCRATCH = Path("/home/tandem/f2r-scratch")
REPO = "NixOS/nixpkgs"
