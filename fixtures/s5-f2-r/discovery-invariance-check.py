#!/usr/bin/env python3
"""S5-F2-R section 4: discovered_options must be byte-identical between
the F1D-R baseline and the F2-R candidate for EVERY PR (changed or not),
since F2 never touches scan_options. Any delta here is unexpected and
