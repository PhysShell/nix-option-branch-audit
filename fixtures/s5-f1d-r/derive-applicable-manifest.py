#!/usr/bin/env python3
"""S5-F1D-R: independently re-derive the frozen applicable/non-applicable
partition from the raw S5 ledger (fixtures/s5-live-pr-shadow/adjudication-ledger.jsonl),
rather than assuming the earlier S5-F1-R/S5-F1B-R applicable-manifest.json is still correct.
...
def main():
    ...
    print("wrote fixtures/s5-f1d-r/applicable-manifest.json (byte-for-byte copy of the verified-identical f1-r manifest)")
